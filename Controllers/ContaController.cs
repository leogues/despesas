...
namespace Despesas.Controllers
{
    public class ContaController : Controller
    {
        ...
        {
            var contas = _context.Contas.Select(x => x);

            
            if (!String.IsNullOrEmpty(searchString))
            {
                contas = contas.Where(s => s.Valor.ToString().Contains(searchString));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Valor,Data,DespesaId")] Conta Conta)
        {
          System.Console.WriteLine(Conta.Data);
